...
<DIV id=foruminfo>
<DIV id=nav>
<P><A id=forumlist href="<%=path %>">玩转西安论坛</A>  » 
${forums.name }</P>
</DIV></DIV>
<DIV id=ad_text></DIV>
  ...
  <c:forEach items="${requestScope.topicList}" var="topic" varStatus="ss">
	<TR id=normalthread_1>
	    <TD class=folder><A title=新窗口打开 
	      ...
	      target=_blank><IMG src="<%=path%>/images/${topic.style}.png"></A></TD>
        <TD class=icon>&nbsp;</TD>  
...
<DIV class=legend>
<LABEL><IMG alt=有新回复 src="<%=path%>/images/yes.png">有新回复</LABEL>
<LABEL><IMG alt=无新回复 src="<%=path%>/images/no.png">无新回复</LABEL>
</DIV>
